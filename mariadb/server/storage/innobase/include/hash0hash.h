...
\
    TYPE* curTail = NULL;\
    if((curTail = (TYPE*)__sync_lock_test_and_set(&cell3333->tail, (DATA))) == NULL){\
        cell3333->node = DATA;\
    } else {\
		curTail->NAME = DATA;\
\
...
\
	if (cell3333->node == DATA) {\
        ...
        if(DATA == cell3333->tail) cell3333->tail = DATA->NAME;\
	} else {\
		struct3333 = (TYPE*) cell3333->node;\
\
...
\
        ...
        if(DATA == cell3333->tail) cell3333->tail = struct3333;}\
	}\
